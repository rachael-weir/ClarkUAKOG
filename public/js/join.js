...
$('.join_mentor_col').append("<img src='img/current_logo.PNG' onclick='onMentor()' class='akog_logo_mentor'/>")
    .append("<h3 role='button' onclick='onMentor()'>Become a Mentor</h3>");

$('.join_mentee_col').append("<img src='img/current_logo.PNG' onclick='onMentee()' class='akog_logo_mentor'/>")
